...
**Decorrelation check:** Verify the monks actually diverged. The skill's value comes from _structurally uncorrelated_ exploration of the problem space. Check:
...
> Here are two essays — each one fully committed to one side of the tension we've been discussing. They're called "Electric Monks" because their job is to _believe_ these positions so you don't have to. That frees you to read both and notice the _structure_ of the disagreement from the outside.
>
