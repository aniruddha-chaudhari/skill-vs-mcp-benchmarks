...
2. Connect agent-browser to that Chrome instance:

```bash
agent-browser connect 9222
```

After this one-time setup for the session, continue with normal `agent-browser` commands.
...
| [templates/launch-chrome-standalone.cjs](templates/launch-chrome-standalone.cjs) | Launch standalone Chrome on 9222    |
